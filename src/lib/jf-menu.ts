...
export const MENU: MenuCategory[] = [
  {
    ...
    label: "start",
    items: [
      { name: "Bukë misri me ajkë speci", price: "250L" },
      { name: "Fokaçe", price: "200L" },
      { name: "Brusket (domate + djath)", price: "250L" },
      { name: "Brusket me fokaçe", price: "300L" },
      { name: "Patëllxhan i tymosur", price: "300L" },
      { name: "Salcë kosi", price: "250L", image: "/images/menu/salce-kosi.png" },
      { name: "Salcë djath pikant", price: "250L" },
      { name: "Gjizë me pesto", price: "250L" },
      { name: "Miks salcash", price: "400L" },
      ...
      { name: "Djath furre kaçkavall", price: "350L", image: "/images/menu/djathe-kackavall-furre.png" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Sallatë jeshile", price: "250L" },
      { name: "Sallatë ulliri", price: "250L" },
      { name: "Sallatë fshati", price: "300L", image: "/images/menu/sallate-fshati.png" },
      { name: "Sallatë greke", price: "350L" },
      { name: "Sallatë mikse", price: "400L" },
      ...
      { name: "Sallata e shefit", price: "550L" },
    ],
  },
  {
    slug: "mishrat",
    ...
    items: [
      ...
      { name: "Kofshë/Shpatull qengji 1Kg (furre)", price: "3000L", image: "/images/menu/kofshe-shpatull-qengji.png" },
      { name: "Mish keçi/qengji (helli)", price: "1200L" },
      { name: "Mish mix 2 persona", price: "1800L" },
      { name: "Mish mix zgare për 4 persona", price: "3500L" },
      { name: "Paidhaqe qengji", price: "1200L" },
      { name: "Paidhaqe gici", price: "900L" },
      { name: "Bërxolla gici", price: "900L" },
      { name: "Bërxolla viçi", price: "1200L" },
      { name: "Biftek zgare", price: "1200L" },
      { name: "Fileto pule", price: "900L" },
      { name: "Fileto viçi në zgarë me perime", price: "1500L" },
      { name: "Rikë me porosi (e pjekur) kg", price: "3500L" },
      { name: "Kalastre sade", price: "2200L" },
      { name: "Kalastre me pilaf / përshesh", price: "2500L", image: "/images/menu/kalastre-pilaf.png" },
      { name: "Tavë qullë arra dhe kalastre", price: "3200L" },
      { name: "Të brendshme zgare", price: "950L" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Qofte me mish viçi (4 copë)", price: "500L" },
      { name: "Qofte perimesh (4 copë)", price: "400L" },
      { name: "Perime zgare", price: "300L", image: "/images/menu/perime-zgare.png" },
      { name: "Qofte viçi", price: "500L" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Fileto pule me salcë agrumesh", price: "1100L" },
    ],
  },
  {
    slug: "embelsira",
